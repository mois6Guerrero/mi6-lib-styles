...
export default {
  root: {
    ...
    invalidBorderColor: MI6_COLORS.error[300],
  ...
  css: `
    ...
    .p-textarea.p-invalid {
      border-color: ${MI6_COLORS.error[300]} !important;
